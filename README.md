# nvim-treesitter-queries-linkerscript

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-linkerscript/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-linkerscript/actions/workflows/validate.yml)

Neovim tree-sitter queries for **linkerscript**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-linkerscript",
...
- [ ] Changes are scoped to `linkerscript` — do not include files for other languages
